...
**Écosystème** : R reste supérieur pour l'analyse statistique classique (modèles linéaires) et possède un bon écosystème de visualisation (ggplot2, Shiny). Julia rattrape rapidement son retard avec des packages comme `Distributions.jl`, `DataFrames.jl` et `Plots.jl`, mais l'écosystème reste moins complet ou du moins nos connaissances sur ce langage reste moins poussées.
...
**En pratique** : Nous envisageons d'utiliser Julia pour nos futurs projets de simulation statistique, d'optimisation ou de modélisation, tout en conservant R pour l'analyse exploratoire, les modèles statistiques classiques et la communication de résultats (RMarkdown, Shiny).
