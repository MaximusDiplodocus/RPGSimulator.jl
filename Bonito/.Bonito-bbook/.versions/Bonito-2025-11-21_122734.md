...
using Bonito, Tables, DataFrames
using RPGSimulator

# Création des personnages
archer = Archer(nom="Jed", stats=Stats(PV=100, PM=20, ATK=30, VITESSE=40, DEFENSE=10))
gobelin = Gobelin(nom="Hussin", stats=Stats(PV=120, PM=0, ATK=35, VITESSE=40, DEFENSE=5))
...
for i in 1:n_simulations
    # Deepcopy pour ne pas modifier les persos originaux
...
# ----------------------
# Remarque : on utilise n_simulations au lieu de N, car c'est le bon keyword argument
all_logs, summary = rand(archer, gobelin; n_simulations=5)

# ----------------------
# Affichage résumé avec Bonito
# ----------------------
# Création d'un div contenant le titre et le tableau
content = Bonito.DOM.div(
    Bonito.DOM.h2("Résumé des combats"),
...
# Simulation de 5 combats
all_logs, summary = rand(archer, gobelin, N=5, out_dir="data")
