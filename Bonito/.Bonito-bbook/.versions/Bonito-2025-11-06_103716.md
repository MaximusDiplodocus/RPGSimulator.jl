...
include("../Examples/test.jl")  # Ou chemin selon ta config
...
# Hypothèse : ajouter simulation de défense moyenne (exemple simulé ici)
# En réalité, remplace cette création par des vraies données de défense
all_logs.defense = [archer.stats.DEFENSE for i in 1:nrow(all_logs)]
all_logs.defense[end÷2:end] .= gobelin.stats.DEFENSE  # moitié pour gobelin
