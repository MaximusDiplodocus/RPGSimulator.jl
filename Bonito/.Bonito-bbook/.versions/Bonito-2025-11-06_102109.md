...
# Crée une figure simple
fig = Figure()
ax = Axis(fig[1,1])
barplot!(ax, 1:3, [5, 2, 7])
ax.xticks = (1:3, ["A", "B", "C"])

# Affichage correct dans Bonito
Bonito.DOM.div(
    Bonito.DOM.h2("Mon graphique simple"),
    Bonito.Makie(fig)  # Bonito expose un wrapper Makie, à utiliser ainsi
)
